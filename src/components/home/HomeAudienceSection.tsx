...
export function HomeAudienceSection({
  ...
  return (
    <section className="border-y border-stone-200/90 bg-[linear-gradient(180deg,_rgba(250,247,241,0.9),_rgba(243,236,226,0.95))] py-16 dark:border-stone-700/80 dark:bg-[linear-gradient(180deg,_rgba(37,31,27,0.94),_rgba(22,30,40,0.94))] sm:py-20">
